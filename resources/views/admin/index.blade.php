...
<div class="col-sm-6 text-left" >
     ...
     <ol class="breadcrumb">
         <li class="breadcrumb-item active">Selamat datang di SIM Absensi Pegawai ITS</li>
     </ol>
</div>
@endsection
...
@section('content')
                   <div class="row">
                                ...
                                <div class="card bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white">Total <br> Pegawai</h5> 
                                        </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white" style="background: rgb(4, 156, 4);">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-left mini-stat-img mr-4">
                                                <i class=" ti-check-box " style="font-size: 30px"></i>
                                            </div>
                                            <h5 class="font-16 text-uppercase mt-0 text-white">On Time <br> Hari ini</h5>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white" style="background: rgb(211, 211, 38);">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-left mini-stat-img mr-4">
                                                <i class="ti-alert" style="font-size: 30px"></i>
                                            </div>
                                            <h5 class="font-16 text-uppercase mt-0 text-white">Terlambat <br> Hari ini</h5>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white" style="background: rgb(202, 5, 5);">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-left mini-stat-img mr-4">
                                                <i class="ti-close" style="font-size: 30px"></i>
                                            </div>
                                            <h6  class="font-16 text-uppercase mt-0 text-white" >Absen <br> Hari ini</h6>
                                            
                                                       
                                        </div>
                                        <h2 class="font-500 float-right">{{$data[3]}}<i class="text-danger ml-2"></i></h2>
                                        <span class="peity-donut float-left" data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72" data-height="72">{{$data[0]}}-{{$data[1]}}-{{$data[2]}}</span>
                                        <!-- <div class="pt-2">
                                            <div class="float-right">
                                                <a href="#" class="text-white-50"><i class="mdi mdi-arrow-right h5"></i></a>
                                            </div>
                                ...
                                <div class="card bg-secondary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white-50">Jadwal <br> Tersedia</h5> 
                                        </div>
